...
| [Header Authentication](#header-authentication) | Variable\. Determined by the algorithm that generated the message\. | 
...
| [Authentication Tag](#body-unframed-tag) | Variable\. Determined by the algorithm implementation used\. | 
