...
For working examples of how to use the AWS Encryption SDK for JavaScript, see the examples in the `example-node` and `example-browser` modules in the [aws\-encryption\-sdk\-javascript](https://github.com/awslabs/aws-encryption-sdk-javascript/) repository on GitHub\.
...
[client\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/client-node)  
Includes all of the modules you need to program with the AWS Encryption SDK for JavaScript in Node\.js\.

[caching\-materials\-manager\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/caching-materials-manager-node)  
...
[decrypt\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/decrypt-node)  
...
[encrypt\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/encrypt-node)  
Exports functions that encrypt and sign different types of data\. Included in the `client-node` module\.

[example\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/example-node)  
...
[hkdf\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/hkdf-node)  
...
[integration\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/integration-node)  
...
[kms\-keyring\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/kms-keyring-node)  
Exports functions that support KMS keyrings in Node\.js\.

[raw\-aes\-keyring\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/raw-aes-keyring-node)  
Exports functions that support [Raw AES keyrings](choose-keyring.md#use-raw-aes-keyring) in Node\.js\.

[raw\-rsa\-keyring\-node](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/raw-rsa-keyring-node)  
...
[client\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/client-browser)  
Includes all of the modules you need to program with the AWS Encryption SDK for JavaScript in the browser\.

[caching\-materials\-manager\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/caching-materials-manager-browser)  
Exports functions that support the [data key caching](data-key-caching.md) feature for JavaScript in the browser\.

[decrypt\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/decrypt-browser)  
Exports functions that decrypt and verify encrypted messages representing data and data streams\.

[encrypt\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/encrypt-browser)  
Exports functions that encrypt and sign different types of data\. 

[example\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/example-browser)  
...
[integration\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/integration-browser)  
...
[kms\-keyring\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/kms-keyring-browser)  
Exports functions that support [KMS keyrings](choose-keyring.md#use-kms-keyring) in the browser\.

[raw\-aes\-keyring\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/raw-aes-keyring-browser)  
Exports functions that support [Raw AES keyrings](choose-keyring.md#use-raw-aes-keyring) in the browser\.

[raw\-rsa\-keyring\-browser](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/raw-rsa-keyring-browser)  
...
[cache\-material](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/cache-material)  
...
[kms\-keyring](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/kms-keyring)  
Exports functions that support [KMS keyrings](choose-keyring.md#use-kms-keyring)\.

[material\-management](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/material-management)  
Implements the [cryptographic materials manager](concepts.md#crypt-materials-manager) \(CMM\)\.

[raw\-keyring](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/raw-keyring)  
Exports functions required for raw AES and RSA keyrings\.

[serialize](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/serialize)  
Exports functions that the SDK uses to serialize its output\.

[web\-crypto\-backend](https://github.com/awslabs/aws-encryption-sdk-javascript/tree/master/modules/web-crypto-backend)  
